...
# Build Gateway Android APK with Ngrok URL
# This script automatically detects the ngrok URL and builds an Android APK
...
echo -e "${GREEN}Building Gateway Android APK...${NC}"
echo ""
...
echo -e "${YELLOW}Note: If ngrok URL changes, you'll need to rebuild the APK${NC}"
