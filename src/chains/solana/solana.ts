...
export class Solana {
  ...
  /**
   * Get token account balance supporting both Token and Token2022 programs
   * @param accountPubkey The token account public key
   * @returns Token account balance response
   */
