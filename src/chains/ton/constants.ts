...
export class Constant {
    ...
    static v1SignInPath = new Constant('Sign In', 'V1 Sign in URL path.', '/v1/signIn');
    static v1BalancesPath = new Constant('Balances', 'V1 Balances URL path.', '/v1/balances');
    static v1MarketsPath = new Constant('Markets', 'V1 Markets URL path.', '/v1/markets');
    static v1MarketPath = new Constant('Market', 'V1 Market URL path.', '/v1/market');
    ...
    static v1RewardsPath = new Constant('Rewards', 'V1 Rewards URL path.', '/v1/rewards');
    ...
    static v2SignInPath = new Constant('Sign In', 'V2 Sign in URL path.', '/v2/signIn');
    static v2BalancesPath = new Constant('Balances', 'V2 Balances URL path.', '/v2/balances');
    ...
    static v2RewardsPath = new Constant('Rewards', 'V2 Rewards URL path.', '/v2/rewards');
