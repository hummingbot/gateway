...
import { OsmosisConfig } from '../../connectors/osmosis/osmosis.config';
...
export const connectorsConfig = [
  ...
  {
    name: 'osmosis',
    trading_types: [...OsmosisConfig.tradingTypes],
    chain: OsmosisConfig.chain,
    networks: [...OsmosisConfig.networks],
  },
];
