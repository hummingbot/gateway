...
import { ETCswapAmmGetPoolInfoRequest } from '../schemas';
  ...
  fastify.get<{
    ...
    '/pool-info',
    {
      schema: {
        ...
        querystring: ETCswapAmmGetPoolInfoRequest,
        response: {
          200: PoolInfoSchema,
        },
      },
    ...
    async (request): Promise<PoolInfo> => {
      try {
        const { poolAddress, network = 'classic' } = request.query;
        ...
        return {
          ...
          feePct: 0.3, // ETCswap V2 fee is fixed at 0.3% (same as Uniswap V2)
          price: price,
