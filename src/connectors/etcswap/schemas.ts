...
// Constants for examples - using Ethereum Classic token symbols
const BASE_TOKEN = 'WETC';
const QUOTE_TOKEN = 'USC';
const SWAP_AMOUNT = 0.1;
const AMM_POOL_ADDRESS_EXAMPLE = '0x8B48dE7cCE180ad32A51d8aB5ab28B27c4787aaf'; // ETCswap V2 WETC-USC pool on classic
const CLMM_POOL_ADDRESS_EXAMPLE = ''; // ETCswap V3 pool address (to be added)

// ========================================
// AMM Request Schemas
// ========================================

export const ETCswapAmmGetPoolInfoRequest = Type.Object({
  network: Type.Optional(
    Type.String({
      description: 'The Ethereum Classic network to use (classic or mordor)',
      default: 'classic',
      enum: [...ETCswapConfig.networks],
    }),
  ),
  poolAddress: Type.String({
    description: 'ETCswap V2 pool address',
...
export const ETCswapClmmGetPoolInfoRequest = Type.Object({
  network: Type.Optional(
    Type.String({
      description: 'The Ethereum Classic network to use (classic or mordor)',
      default: 'classic',
  ...
  poolAddress: Type.String({
    description: 'ETCswap V3 pool address',
...
// ETCswap-specific quote-swap request
export const ETCswapQuoteSwapRequest = Type.Object({
  network: Type.Optional(
    Type.String({
      description: 'The Ethereum Classic network to use (classic or mordor)',
      default: 'classic',
  ...
  slippagePct: Type.Optional(
    Type.Number({
      ...
      default: ETCswapConfig.config.slippagePct,
    }),
  ),
...
// ETCswap-specific quote-swap response
export const ETCswapQuoteSwapResponse = Type.Object({
  quoteId: Type.String({
...
// ETCswap-specific execute-quote request
export const ETCswapExecuteQuoteRequest = Type.Object({
  walletAddress: Type.Optional(
    Type.String({
  ...
  network: Type.Optional(
    Type.String({
      description: 'The Ethereum Classic network to use',
      default: 'classic',
      enum: [...ETCswapConfig.networks],
    }),
  ),
...
// ETCswap AMM Add Liquidity Request
export const ETCswapAmmAddLiquidityRequest = Type.Object({
  network: Type.Optional(
    Type.String({
      description: 'The Ethereum Classic network to use',
      default: 'classic',
  ...
  poolAddress: Type.String({
    description: 'Address of the ETCswap V2 pool',
  }),
...
// ETCswap AMM Remove Liquidity Request
export const ETCswapAmmRemoveLiquidityRequest = Type.Object({
  network: Type.Optional(
    Type.String({
      description: 'The Ethereum Classic network to use',
      default: 'classic',
...
// ETCswap AMM Execute Swap Request
export const ETCswapAmmExecuteSwapRequest = Type.Object({
  walletAddress: Type.Optional(
    Type.String({
      description: 'Wallet address that will execute the swap',
      default: ethereumChainConfig.defaultWallet,
...
// ETCswap-specific execute-swap request
export const ETCswapExecuteSwapRequest = Type.Object({
  walletAddress: Type.Optional(
    Type.String({
      description: 'Wallet address that will execute the swap',
      default: ethereumChainConfig.defaultWallet,
...
// ETCswap CLMM Open Position Request
export const ETCswapClmmOpenPositionRequest = Type.Object({
  network: Type.Optional(
    Type.String({
      description: 'The Ethereum Classic network to use',
      default: 'classic',
  ...
  poolAddress: Type.String({
    description: 'Address of the ETCswap V3 pool',
  }),
...
// ETCswap CLMM Add Liquidity Request
export const ETCswapClmmAddLiquidityRequest = Type.Object({
  network: Type.Optional(
    Type.String({
      description: 'The Ethereum Classic network to use',
      default: 'classic',
...
// ETCswap CLMM Remove Liquidity Request
export const ETCswapClmmRemoveLiquidityRequest = Type.Object({
  network: Type.Optional(
    Type.String({
      description: 'The Ethereum Classic network to use',
      default: 'classic',
...
// ETCswap CLMM Close Position Request
export const ETCswapClmmClosePositionRequest = Type.Object({
  network: Type.Optional(
    Type.String({
      description: 'The Ethereum Classic network to use',
      default: 'classic',
...
// ETCswap CLMM Collect Fees Request
export const ETCswapClmmCollectFeesRequest = Type.Object({
  network: Type.Optional(
    Type.String({
      description: 'The Ethereum Classic network to use',
      default: 'classic',
...
// ETCswap CLMM Execute Swap Request
export const ETCswapClmmExecuteSwapRequest = Type.Object({
  walletAddress: Type.Optional(
    Type.String({
      description: 'Wallet address that will execute the swap',
      default: ethereumChainConfig.defaultWallet,
