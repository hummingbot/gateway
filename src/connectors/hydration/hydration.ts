...
export class Hydration {
  ...
  @runWithRetryAndTimeout()
  private tradeRouterGetBestSell(assetIn: string, assetOut: string, amountIn: BigNumber | string | number): Promise<Trade> {
    return this.getNewTradeRouter().getBestSell(assetIn, assetOut, amountIn);
  }

  @runWithRetryAndTimeout()
  private tradeRouterGetBestBuy(assetIn: string, assetOut: string, amountIn: BigNumber | string | number): Promise<Trade> {
    return this.getNewTradeRouter().getBestBuy(assetIn, assetOut, amountIn);
  }
