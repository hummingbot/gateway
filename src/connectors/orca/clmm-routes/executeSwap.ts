...
export async function executeSwap(
  ...
  // this avoids an extra co-signer (so Privy/Ledger can sign alone) and lets a wallet
  ...
  // Kit signer for the wallet: local keypair, or Privy (signs through Privy with the
  // wallet policy enforced). Composes with signTransactionMessageWithSigners below.
  const signer = await solana.getSolanaKitSigner(walletAddress);
