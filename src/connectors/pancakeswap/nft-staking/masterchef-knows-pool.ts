  ...
  fastify.post<{ Body: MasterChefKnowsPoolRequest }>(
    '/masterchef-knows-pool',
    {
      schema: {
        ...
        description:
          'Checks if the given PancakeSwap V3 pool address is registered in the MasterChef contract (using v3PoolAddressPid). ' +
          'Returns the pool ID if registered, or 0 if not.',
