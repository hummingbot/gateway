    ...
    '/masterchef-unstake-and-close',
    {
      schema: {
        ...
        description:
          ...
          'This is a convenience endpoint that chains two operations: unstake (withdraw from MasterChef, harvesting CAKE) ' +
          'and close-position (remove liquidity and burn NFT). ' +
          'The response includes: CAKE rewards earned during unstake, token symbols and amounts returned when closing, ' +
          'and all collected trading fees.',
        ...
        response: {
          200: Type.Object({
            ...
            positionClosed: Type.Object({
              ...
              quoteTokenAmountRemoved: Type.Number({ description: 'Amount of quote token removed from the position' }),
