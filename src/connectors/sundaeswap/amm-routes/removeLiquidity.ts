import { EDatumType, IWithdrawConfigArgs, TSupportedNetworks } from '@aiquant/sundaeswap-core';
  ...
  fastify.post<{
    ...
    async (request) => {
      try {
        ...
        const wallet = await sundaeswap.cardano.getWalletFromAddress(walletAddress);
