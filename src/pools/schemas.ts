...
export const FindPoolsQuerySchema = Type.Object({
  ...
  connector: Type.Optional(
    Type.String({
      description:
        'Filter by connector name (e.g., raydium, meteora, uniswap, pancakeswap, pancakeswap-sol, orca, pumpswap)',
      examples: ['raydium', 'meteora', 'uniswap', 'pancakeswap', 'pancakeswap-sol', 'orca', 'pumpswap'],
    }),
  ),
  type: Type.Optional(
    Type.String({
