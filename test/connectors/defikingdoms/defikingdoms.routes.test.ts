...
const patchGetTokenByAddress = () => {
  patch(defikingdoms, 'getTokenByAddress', () => {
    return {
      chainId: 1666700000,
      name: 'WONE74',
      symbol: 'WONE74',
...
const patchEstimateBuyTrade = () => {
  patch(defikingdoms, 'estimateBuyTrade', () => {
    return {
      expectedAmount: {
        toSignificant: () => 100,
      },
...
const patchEstimateSellTrade = () => {
  patch(defikingdoms, 'estimateSellTrade', () => {
    return {
      expectedAmount: {
        toSignificant: () => 100,
      },
...
const patchExecuteTrade = () => {
  patch(defikingdoms, 'executeTrade', () => {
...
describe('POST /amm/price', () => {
  ...
  it('should return 500 when the priceSwapIn operation fails', async () => {
    ...
    patchGetTokenBySymbol();
    patchGetTokenByAddress();
    patch(defikingdoms, 'priceSwapIn', () => {
      return 'error';
    });
  ...
  it('should return 500 when the priceSwapOut operation fails', async () => {
    ...
    patchGetTokenBySymbol();
    patchGetTokenByAddress();
    patch(defikingdoms, 'priceSwapOut', () => {
      return 'error';
    });
