...
const { FeeAmount, Pool } = require('@pancakeswap/v3-sdk');
...
const WBNB_ADDRESS = '0x4200000000000000000000000000000000000006'; // WBNB on Base
const USDC_ADDRESS = '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913'; // USDC on Base
const FEE = FeeAmount.LOW; // 0.05%
const POOL_ADDRESS = '0xd0b53d9277642d899df5c87a3966a349a798f224'; // Known WBNB-USDC pool on Base

describe('Pancakeswap Tick Data Provider Tests', () => {
  // Create token instances for testing
  const wbnb = new Token(8453, WBNB_ADDRESS, 18, 'WBNB', 'Wrapped Ether');
