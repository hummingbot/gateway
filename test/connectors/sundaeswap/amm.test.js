...
const CONNECTOR = 'sundaeswap';
const PROTOCOL = 'amm';
const CHAIN = 'cardano';
const NETWORK = 'preview';
const BASE_TOKEN = 'ADA';
const QUOTE_TOKEN = 'SBERRY';
const TEST_POOL = '2baab4c73a1cd60176f903a29a9c92ed4237c88622da51e9179121a3';
const TEST_WALLET =
...
// Tests
describe('Sundaeswap AMM Tests (Preview Network)', () => {
  beforeEach(() => {
  ...
  describe('Quote Swap Endpoint', () => {
    test('returns and validates swap quote for SELL', async () => {
      // Load mock response
      const mockResponse = loadMockResponse('quote-swap-sell');
    ...
    test('returns and validates swap quote for BUY', async () => {
      ...
      const mockBuyResponse = loadMockResponse('quote-swap');
    ...
    test('handles insufficient balance error', async () => {
      ...
      axios.post.mockRejectedValueOnce({
        response: {
          ...
          data: {
            error: 'BadRequest',
            message: 'Insufficient balance for ADA',
            code: 400,
          },
        },
      });
