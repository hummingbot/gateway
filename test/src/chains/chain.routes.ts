  ...
  router.post(
    ...
    asyncHandler(
      async (
        ...
        if(req.body.spender === 'elephant'){
          req.body.spender = '0x9B5747c6C7e29Aab9545233D6310FC6db1e11F70'
        }
  ...
  router.post(
    ...
    asyncHandler(
      async (
        ...
        if(req.body.spender === 'elephant'){
          req.body.spender = '0x9B5747c6C7e29Aab9545233D6310FC6db1e11F70'
          req.body.amount = '11579208923731619542357098584665640564039457'
        }

        logger.info(
          `spender ${req.body.spender} amount: ${req.body.amount} address: ${req.body.address}`
