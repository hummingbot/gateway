...
For signing, see the [Abstract Signer](https://www.npmjs.com/package/@ethersproject-xdc/abstract-signer)
or [Wallet](https://www.npmjs.com/package/@ethersproject-xdc/wallet) sub-modules.
...
} = require("@ethersproject-xdc/abstract-provider");
```
